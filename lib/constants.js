...
const COMPETITION_SCHEDULE = [
  ...
  {week:10, name:"CSP-S1", difficulty:55, maxScore:100, numProblems:1},
  // CSP-S2: 保持不变（4 题）
  {week:15, name:"CSP-S2", difficulty:175, maxScore:400, numProblems:4},
  // NOIP: 保持不变（4 题）
  {week:20, name:"NOIP", difficulty:235, maxScore:400, numProblems:4},
  // 省选：6 道题（总分 600）
  {week:37, name:"省选", difficulty:300, maxScore:600, numProblems:6},
  // NOI：7 道题（总分 700），第一题包含所有 TAG
  {week:50, name:"NOI", difficulty:400, maxScore:700, numProblems:7}
];
// 明确的比赛链顺序（用于链式晋级判断）
