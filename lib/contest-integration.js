    ...
    if(eligibleStudents.length === 0){
      ...
      if(halfIndex === 0){
        ...
        if(typeof window.showModal === 'function' && typeof window.closeModal === 'function'){
          window.showModal(`<h3>晋级链断裂</h3><div class="small">第二轮赛季${comp.name}无学生晋级，游戏结束。</div><div style="text-align:right;margin-top:8px"><button class="btn" onclick="(function(){ closeModal(); window.location.href='end.html'; })()">查看结算页面</button></div>`);
        } else {
