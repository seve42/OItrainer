...
const COMPETITION_SCHEDULE = [
  ...
  {week:9, name:"CSP-S1", difficulty:55, maxScore:100, numProblems:1},
  {week:17, name:"CSP-S2", difficulty:175, maxScore:400, numProblems:4},
  {week:25, name:"NOIP", difficulty:235, maxScore:400, numProblems:4},
  {week:40, name:"省选", difficulty:320, maxScore:600, numProblems:6},
  {week:52, name:"NOI", difficulty:360, maxScore:700, numProblems:7}
];
// 明确的比赛链顺序（用于链式晋级判断）
...
/* 训练 */
const TRAINING_BASE_KNOWLEDGE_GAIN_PER_INTENSITY = 5;
...
const MOCK_CONTEST_DIFF_VALUES = [30, 50, 120, 320, 370];
/* 娱乐 */
