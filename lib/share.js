    ...
    try {
      ...
      const shareData = {
        ...
        gameState: {
          ...
          // 游戏难度（1=简单,2=普通,3=困难）
          difficulty: (typeof gameData.difficulty !== 'undefined') ? gameData.difficulty : (gameData.d ? gameData.d : 2),
          // 可读标签，方便分享页面直接显示
          difficultyLabel: (function(d){ return d === 1 ? '简单' : (d === 3 ? '困难' : '普通'); })( (typeof gameData.difficulty !== 'undefined') ? gameData.difficulty : (gameData.d ? gameData.d : 2) ),
