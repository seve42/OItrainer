...
const COMPETITION_SCHEDULE = [
  ...
  {week:54, name:"CTT-day1-2", difficulty:500, maxScore:600, numProblems:6, nationalTeam:true},
  {week:55, name:"CTT-day3-4", difficulty:500, maxScore:600, numProblems:6, nationalTeam:true},
  {week:56, name:"CTS", difficulty:520, maxScore:800, numProblems:8, nationalTeam:true},
  {week:57, name:"IOI", difficulty:520, maxScore:600, numProblems:6, nationalTeam:true, subtasksPerProblem:15}
];
...
const OTHER_CONTRY_MIN_ABILITY = 150;
// IOI奖牌线（相对总分的百分比）
...
const CONTEST_MAX_TOTAL_THINKING_GAIN = 10.0;    // 思维总增幅上限（低于基础集训的12）
const CONTEST_MAX_TOTAL_CODING_GAIN = 10.0;      // 代码总增幅上限（低于基础集训的12）
