...
const COMPETITION_SCHEDULE = [
  ...
  {week:17, name:"CSP-S2", difficulty:205, maxScore:400, numProblems:4},
  {week:25, name:"NOIP", difficulty:245, maxScore:400, numProblems:4},
...
const TRAINING_THINKING_GAIN_MIN = 0.45;
const TRAINING_CODING_GAIN_MIN = 0.45;
...
// 将此值调大可放大影响，调小则减弱影响。
const DIFFICULTY_TO_SKILL_SLOPE = 1.1;
// 专门用于调整“思维难度”的额外系数（相对于归一化后的基础难度的百分比）
// 例如 0.15 表示思维难度比基础难度高 15%。可调以改变思维偏难程度。
const THINKING_DIFFICULTY_BONUS = 0.15;
