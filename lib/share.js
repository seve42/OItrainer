      ...
      try {
        ...
        if (gameData.devToolsDetection) {
          ...
          try {
            ...
            console.error('Failed to verify devTools integrity:', e);
          }
          
          console.log('[ShareManager] 从存档读取 devTools 检测结果:', devToolsResult);
        ...
        console.error('Failed to get DevTools detection result:', e);
      }
